...
int main(void) {
   imprima("s", "digite um numero que voce quer tirar a raiz quadrada:");
   _r = leia_real();
   imprima("s", "digite um palpite aproximado da sua raiz para que o programa lhe der o resultado esperado");
   _x = leia_real();
   imprima("sf", "o valor da raiz eh:", _raiz(_x));
   cleanup();
   return EXIT_SUCCESS;
}
double _raiz(double _x) {
