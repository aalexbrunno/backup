...
void multMatriz(int **arrayA, int **arrayB, int **arrayC, int linhaA, int linhaB, int colunaB);
...
// L = 3 e C = 4
    ...
    print(matrizA, linhaA, colunaA);

    printf("\n");

    printf("MATRIZ 2\n");

    print(matrizB, linhaB, colunaB);

    printf("\n");


    multMatriz(matrizA, matrizB, matrizC, linhaA, linhaB, colunaB);
