...
/**
 * @ingroup GroupUnique
 * @brief predicatos vaipara e apontar para
 * @details recebe uma coordenada e retorna uma acão que esta descrita 
 * @return uma acão que vai depender das persepções
 */
