...
/* pega linhas e colunas da matriz e também aloca memoria*/
...
/* verificar se os dados passados pelo usuario são validos. No caso as linhas e as colunas*/
...
int main(void)
{
    ...
    matriz1 = criarMatriz(linhasMatriz1, colunasMatriz1);
    ...
    if(matriz1 != NULL)
    {
        ...
        printf("\n");
        printf("MATRIZ 1 \n");
        printMatriz(matriz1, linhasMatriz1, colunasMatriz1);
        printf("\n");
        ...
        matriz2 = criarMatriz(linhasMatriz2, colunasMatriz2);
    }
    ...
    if(matriz1 != NULL && matriz2 != NULL)
    {
        ...
        printf("\n");
        printf("MATRIZ 2 \n");
        printMatriz(matriz2, linhasMatriz2, colunasMatriz2);
        printf("\n");
