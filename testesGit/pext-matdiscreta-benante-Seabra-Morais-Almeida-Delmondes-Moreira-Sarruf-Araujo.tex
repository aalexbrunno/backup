...
A implementaçãao será feita por meio da criação de uma playlist em um canal específico do projeto na plataforma de compartilhamento de vídeos escolhida pelo professor orientador.
