...
O projeto tem como objetivo principal contribuir para melhorar o ensino dos discentes interessados promovendo ações para capacitação da comunidade a fim de colaborar com o desenvolvimento técnico científico.
...
A razão da implementação desse projeto é buscar a democratização do conhecimento visto que existem poucos conteúdos na língua portuguesa no youtube sobre a biblioteca Ncurses.
