 /**************************************************************************
 *   pe42.c                                   Version 20190817.235856      *
 *                                                                         *
 *   Project Euler                                                         *
...
/* ---------------------------------------------------------------------- */
/* prototypes */
void pe42(void); /* Proj. Euler problem #42 */

/* ---------------------------------------------------------------------- */
/* main function */
/* Do not change the main function. Use the void pe42(void) and
...
int main(void)
{
    ...
    pe42(); /* Proj. Euler problem #42 */
    LEGOsignals(); /* restore interruption signals */
    return EXIT_SUCCESS;
}

/* ---------------------------------------------------------------------- */
/* Proj. Euler problem #42 */
/* Problem description:
 *
 */
