...
/* funcao que imprime o conjunto de formularios para insercao de dados de registro de clientes */
void printFormRegClient(wins_t *pw2, FIELD *fields[], FORM *form, livro_t *pw);
/* funcao que imprime o conjunto de formularios para pesquisa de livros */
