...
O projeto tem como objetivo contribuir no processo de ensino-aprendizagem do cidadão interessado em imergir nas linguagens de programação promovendo ações para capacitação da comunidade a fim de colaborar com o desenvolvimento técnico científico.
...
\begin{itemize}
 ...
 \item Democratizar aulas de Ncurses, em português, no Youtube não só para a comunidade acadêmica mas também para a população externa.
\end{itemize}
...
\centering
\includegraphics[width=.50\linewidth]{imagens/imagem.png}
