...
\begin{figure}[!htbp] %modificação feita para fixar a imagem ht
\centering
\includegraphics[width=.30\linewidth]{imagem.png}
 ...
 \begin{enumerate}
  \item Etapa de fundamentação e organização:
      \begin{enumerate}
         ...
         \item criação dos projetos de fixação(prototipos para treinamento e nivelamento). 
     \end{enumerate}    
