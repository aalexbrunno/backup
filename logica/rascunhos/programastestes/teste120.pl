...
regra2(_,_,_,_,5,espanhou,_,_,_,cachorro,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).

% Na casa verde se bebe água
regra3(_,verde,agua,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra3(_,_,_,_,5,_,verde,agua,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra3(_,_,_,_,5,_,_,_,_,5,_,verde,agua,_,5,_,_,_,_,5,_,_,_,_,5).
regra3(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,verde,agua,_,5,_,_,_,_,5).
regra3(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,verde,agua,_,5).

% O Ucraniano bebe chá
regra4(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,ucraniano,_,cha,_,5).
...
regra5(_,_,_,winston,serpente,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra5(_,_,_,_,5,_,_,_,winston,serpente,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra5(_,_,_,_,5,_,_,_,_,5,_,_,_,winston,serpente,_,_,_,_,5,_,_,_,_,5).
regra5(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,,winston,serpente,_,_,_,_,5).
regra5(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,winston,serpente).

% Na casa amarela se fuma Kool
regra6(_,amarela,_,kool,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra6(_,_,_,_,5,_, amarela,_,kool,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra6(_,_,_,_,5,_,_,_,_,5,_,amarela,_,kool,5,_,_,_,_,5,_,_,_,_,5).
regra6(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,amarela,_,kool,5,_,_,_,_,5).
regra(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,amarela,_,kool,5).
...
% regra(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra13(_,_,suco,lucky-strike,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra13(_,_,_,_,5,_,_,suco,lucky-strike,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5).
regra13(_,_,_,_,5,_,_,_,_,5,_,_,suco,lucky-strike,5,_,_,_,_,5,_,_,_,_,5).
regra13(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,suco,lucky-strike,5,_,_,_,_,5).
regra13(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,_,_,suco,lucky-strike,5).

% O Japonês fuma Kent.
regra14(_,_,_,_,5,_,_,_,_,5,_,_,_,_,5,japones,_,kent,_,5,_,_,_,_,5).
