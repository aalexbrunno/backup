...
double _area(double _x);
double _b = 0;
double _x = 0;
double _a = 0;

int main(void) {
   imprima("s", "digite um valor para base:");
   _b = leia_real();
   imprima("s", "digite um valor para altura");
   _a = leia_real();
   imprima("sf", "o valor da base:", _area(_x));
   cleanup();
   return EXIT_SUCCESS;
}
double _area(double _x) {
