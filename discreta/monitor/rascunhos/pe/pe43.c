 /**************************************************************************
 *   pe43.c                                   Version 20190817.235856      *
 *                                                                         *
 *   Project Euler                                                         *
...
/* ---------------------------------------------------------------------- */
/* prototypes */
void pe43(void); /* Proj. Euler problem #43 */

/* ---------------------------------------------------------------------- */
/* main function */
/* Do not change the main function. Use the void pe43(void) and
...
int main(void)
{
    ...
    pe43(); /* Proj. Euler problem #43 */
    LEGOsignals(); /* restore interruption signals */
    return EXIT_SUCCESS;
}

/* ---------------------------------------------------------------------- */
/* Proj. Euler problem #43 */
/* Problem description:
 *
 */
