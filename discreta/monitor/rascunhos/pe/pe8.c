...
void pe8(void)
{
	...
	long long produto, maxproduto;
	int i, limbaixo, limalto;
	
	int intvetor [1000];
	char BFN[] = "73167176531330624919225119674426574742355349194934"
